...
describe "As an admin" do
  describe "when I visit a cohort show page" do
    it "I can make assignments" do
      ...
      student_1 = User.create(first_name: "Jane", last_name: "Johnson", turing_cohort: cohort, census_id: 1)
      student_2 = User.create(first_name: "John", last_name: "Johnson", turing_cohort: cohort, census_id: 2)
      student_3 = User.create(first_name: "Jessica", last_name: "Johnson", turing_cohort: cohort, census_id: 3)
      User.create(first_name: "Jerry", last_name: "Johnson", turing_cohort: cohort, census_id: 4)
